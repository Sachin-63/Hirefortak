...
const ReviewCard = (props) => {
    return (
        <div >
            <div class="card" style={{whiteSpace:"normal"}} >
            <div class="card-body" >
                <p  class="card-text mb-5" style={{fontSize:'80%'}}><i style={{color:"blue"}} class="fas fa-quote-left mx-2"></i>I discussed with Mr. Arvind ji and I'm very satisfied with the discussion. He has very good knowledge and understanding and told correctly. My questions are clearly answered and I want to contact with him further for my family as well. Thank you for your support.<i style={{color:"blue"}} class="fas fa-quote-right mx-2"></i></p>
                <br/>
                <br/>
                <h5 class="card-title  position-absolute start-50 translate-middle mb-0" style={{zIndex:"102",bottom:"5%",width:"100%"}}>{props.n}</h5>
                ...
                <i class=" position-absolute  start-50 translate-middle-x fas fa-user-circle" style={{zIndex:"102",bottom:"20%",fontSize:"320%",color:"#ff6702"}}></i>
